...
public class FloatflingRightclickedProcedure {
			...
			return;
		{
			...
			for (Entity entityiterator : _entfound) {
				if (entity instanceof LivingEntity _entity && !_entity.level.isClientSide())
					_entity.addEffect(new MobEffectInstance(MobEffects.LEVITATION, 50, 5, false, false));
				sourceentity.setDeltaMovement(new Vec3(0, (-10 + entity.getLookAngle().y), 0));
			}
		}
	}
}
